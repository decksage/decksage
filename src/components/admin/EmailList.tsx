                    ...
                    {broadcasts.length === 0 ? (
                        ...
                        broadcasts.map((email) => (
                            <TableRow key={email.id} className="border-neutral-800 hover:bg-neutral-800/50">
                                ...
                                <TableCell>
                                    <Badge variant={email.status === 'sent' ? 'default' : 'secondary'} className={email.status === 'sent' ? 'bg-green-900 text-green-300 hover:bg-green-900' : 'bg-neutral-700 text-neutral-300 hover:bg-neutral-700'}>
