    ...
    <form action={handleSubmit}>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="bg-neutral-900 border-neutral-800">
            <CardHeader>
              <CardTitle>Conteúdo para Redes Sociais</CardTitle>
            </CardHeader>
            <CardContent>
              <Tabs defaultValue="facebook">
                ...
                <TabsContent value="facebook">
                  <Textarea
                    ...
                    defaultValue={deck.social_posts?.facebook || ''}
                    rows={8}
                  />
                </TabsContent>
                <TabsContent value="instagram">
                  <Textarea
                    ...
                    defaultValue={deck.social_posts?.instagram || ''}
                    rows={8}
                  />
                </TabsContent>
                <TabsContent value="x">
                  <Textarea
                    name="social_post_x"
                    defaultValue={deck.social_posts?.x || ''}
                    rows={8}
                  />
                </TabsContent>
                <TabsContent value="reddit">
                  <Textarea
                    name="social_post_reddit"
                    defaultValue={deck.social_posts?.reddit || ''}
                    rows={8}
                  />
                </TabsContent>
              </Tabs>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <Card className="bg-neutral-900 border-neutral-800">
            <CardHeader>
              <CardTitle>Análise (Deck Check)</CardTitle>
            </CardHeader>
            <CardContent className="space-y-2 text-sm">
              <Label>Estilo de Jogo</Label>
              <Input name="deck_check_playstyle" defaultValue={deck.deck_check?.playstyle || ''} />
              <Label>Condição de Vitória</Label>
              <Input
                name="deck_check_win_condition"
                defaultValue={deck.deck_check?.win_condition || ''}
              />
              <Label>Dificuldade</Label>
              <Input
                name="deck_check_difficulty"
                defaultValue={deck.deck_check?.difficulty || ''}
              />
              <Label>Pontos Fortes (separados por vírgula)</Label>
              <Textarea
                name="deck_check_strengths"
                defaultValue={deck.deck_check?.strengths?.join(', ') || ''}
                rows={3}
              />
              <Label>Pontos Fracos (separados por vírgula)</Label>
              <Textarea
                name="deck_check_weaknesses"
                defaultValue={deck.deck_check?.weaknesses?.join(', ') || ''}
                rows={3}
              />
            </CardContent>
          </Card>
          <Card className="bg-neutral-900 border-neutral-800">
            <CardHeader>
              <CardTitle>Guia de Como Jogar</CardTitle>
            </CardHeader>
            <CardContent>
              <Textarea
                name="how_to_play_guide"
                defaultValue={deck.how_to_play_guide || ''}
                rows={10}
              />
            </CardContent>
          </Card>
