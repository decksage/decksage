    ...
    <form action={dispatch}>
      <Card className="bg-neutral-900 border-neutral-800">
        <CardHeader>
          ...
          <CardDescription>
            {isEditing
              ? `Configure o slot: ${adSlot.slot_name}`
              : 'Defina um novo espaço para anúncios no site.'}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="flex items-center space-x-2">
            <Switch
              id="is_active"
              name="is_active"
              defaultChecked={isEditing ? adSlot.is_active : true}
            />
          ...
          <div className="space-y-2">
            ...
            {isEditing && (
              <p className="text-xs text-neutral-500">
                O nome do slot não pode ser alterado após a criação.
              </p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select name="ad_type" value={adType} onValueChange={(value) => setAdType(value)}>
              <SelectTrigger className="w-[280px] bg-neutral-800 border-neutral-700">
                <SelectValue />
              </SelectTrigger>
            ...
            <div className="p-4 border-l-4 border-amber-500 bg-neutral-800/50 rounded-r-lg space-y-4 animate-in fade-in">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  defaultValue={adSlot?.adsense_client_id || ''}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  defaultValue={adSlot?.adsense_slot_id || ''}
                  className="bg-neutral-800 border-neutral-700 font-mono"
                />
              </div>
            </div>
            ...
            <div className="p-4 border-l-4 border-sky-500 bg-neutral-800/50 rounded-r-lg space-y-4 animate-in fade-in">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  defaultValue={adSlot?.custom_image_url || ''}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  defaultValue={adSlot?.custom_link_url || ''}
                  className="bg-neutral-800 border-neutral-700"
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  name="custom_alt_text"
                  defaultValue={adSlot?.custom_alt_text || ''}
                  className="bg-neutral-800 border-neutral-700"
                />
              </div>
            </div>
