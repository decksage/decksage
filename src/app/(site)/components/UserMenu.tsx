    ...
    <>
      <nav className="flex items-center gap-4 md:gap-6 text-neutral-200">
        ...
        <Button
          ...
          variant="secondary"
          size="sm"
          className="bg-sky-500/10 text-sky-300 hover:bg-sky-500/20 border border-sky-500/20 h-9"
        >
        ...
        {user ? (
          <DropdownMenu>
            ...
            <DropdownMenuContent
              className="w-64 bg-neutral-900 border-neutral-700 text-neutral-200"
              align="end"
              forceMount
            >
      ...
      <Dialog open={isReferralDialogOpen} onOpenChange={setIsReferralDialogOpen}>
        <DialogContent className="bg-neutral-900 border-neutral-800">
          <DialogHeader>
            ...
            <DialogDescription>
              Compartilhe seu link exclusivo abaixo. Para cada amigo que se cadastrar, você ganha
              pontos.
            </DialogDescription>
          </DialogHeader>
          <div className="pt-4">
