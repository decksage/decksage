        ...
        <form action={formAction} className="space-y-6">
            {!user && (
                <>
                    <div className="space-y-2">
                        ...
                        <Input id="user_name" name="user_name" placeholder="Seu nome" className="bg-neutral-800 border-neutral-700" />
                    </div>

                    <div className="space-y-2">
                        <Label htmlFor="user_email">Email</Label>
                        <Input id="user_email" name="user_email" type="email" placeholder="seu@email.com" className="bg-neutral-800 border-neutral-700" />
                    </div>
                </>
            )}
            ...
            {user && (
                <div className="p-4 bg-neutral-800/50 rounded-lg border border-neutral-700 text-sm text-neutral-300">
                    <p>Logado como <strong>{userName || 'Usuário'}</strong></p>
            ...
            <Button type="submit" disabled={isPending} className="w-full bg-amber-600 hover:bg-amber-700 text-white font-bold py-2">
