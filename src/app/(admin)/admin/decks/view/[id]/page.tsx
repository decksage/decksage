  ...
  return (
    <div className="max-w-7xl mx-auto">
      <header className="mb-8">
        <Link
          href="/admin/decks"
          className="inline-flex items-center gap-2 text-sm text-neutral-400 hover:text-amber-400 mb-4"
        >
      ...
      <Tabs defaultValue="decklist" className="w-full">
        ...
        <TabsContent value="decklist">
          <Card className="bg-neutral-900 border-neutral-800 mt-4">
            ...
            <CardContent>
              <DecklistVisualizer decklist={deck.decklist} />
            </CardContent>
          </Card>
        </TabsContent>
            ...
            <CardContent className="space-y-4">
              {Object.entries(socialPosts).map(([platform, text]) => (
                <div key={platform}>
                  ...
                  <p className="text-sm p-4 bg-neutral-950 rounded-md whitespace-pre-wrap border border-neutral-700">
                    {(text as string) || 'Não gerado.'}
                  </p>
                </div>
              ))}
            </CardContent>
