...
export default async function BlogHubPage({ searchParams }: { searchParams?: { page?: string } }) {
  ...
  const { data: posts, error } = await supabase.rpc('get_published_posts_paginated', {
    ...
    <div>
      <header className="mb-12 border-b border-neutral-800 pb-6">
        ...
        <p className="text-lg text-neutral-400 mt-2">
          Todos os nossos artigos, análises e guias para você.
        </p>
      </header>
      ...
      {regularPosts.length > 0 ? (
        ...
        currentPage === 1 && (
          <p className="text-center text-neutral-500 py-10">Nenhum artigo publicado ainda.</p>
        )
      )}
