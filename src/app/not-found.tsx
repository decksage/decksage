  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col items-center justify-center text-center p-4">
      <div className="relative mb-6">
        ...
        <span className="absolute -top-2 -right-3 text-7xl font-bold text-amber-500/80 animate-pulse">
          ?
        </span>
      </div>
      ...
      <h2 className="mt-4 text-2xl md:text-3xl font-bold text-amber-500">Página Exilada</h2>

      <p className="mt-2 max-w-md text-base text-neutral-400">
        Parece que o planeswalker que você procura viajou para um plano desconhecido. O link pode
        estar quebrado ou a página foi enviada para o cemitério.
      </p>
