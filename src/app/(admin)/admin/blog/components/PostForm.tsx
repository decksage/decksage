...
const Editor = dynamic(() => import('./Editor'), {
  ssr: false,
  loading: () => (
    <div className="p-4 text-neutral-400 border border-neutral-700 rounded-md min-h-[500px]">
      Carregando editor...
    </div>
  ),
});
...
function SubmitButton() {
  ...
  return (
    <Button
      type="submit"
      className="bg-amber-500 text-black hover:bg-amber-600 w-full"
      disabled={pending}
    >
      {pending ? (
        <>
  ...
  return (
    <form action={dispatch} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <aside className="lg:col-span-1 space-y-6 lg:sticky lg:top-8 self-start">
        ...
        <Card className="bg-neutral-900 border-neutral-800">
          <CardHeader>
            <CardTitle>Resumo & SEO</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Um resumo curto para a lista do blog."
              />
            </div>
            <div className="space-y-2">
