...
function BuildButton({ isDisabled }: { isDisabled: boolean }) {
  ...
  return (
    <Button size="lg" type="submit" className="w-full" disabled={pending || isDisabled}>
      {pending ? (
        <>
          <Loader2 className="mr-2 h-5 w-5 animate-spin" /> Construindo...
        </>
      ) : (
        <>
          <Sparkles className="mr-2 h-5 w-5" /> Construir com IA
        </>
      )}
    </Button>
  );
  ...
  return (
    <Button type="submit" size="lg" disabled={pending} className="bg-green-600 hover:bg-green-700">
      {pending ? (
        ...
        <>
          <Save className="mr-2 h-4 w-4" /> Salvar na Minha Conta
        </>
      )}
    </Button>
  );
...
export default function DeckBuildPage() {
  ...
  const isBuildDisabled =
    !format ||
    (format !== 'commander' && !userPrompt.trim()) ||
    (format === 'commander' && !commander && !userPrompt.trim());
      ...
      <div className="container mx-auto max-w-4xl py-8 animate-in fade-in">
        ...
        <div className="space-y-6">
          <Card className="bg-neutral-900 border-neutral-800">
            <CardHeader>
              <CardTitle>Decklist Gerada ({totalGeneratedCards} cartas)</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          >
            ...
            <SaveButton />
            <Button variant="outline" type="button" size="lg" onClick={handleTryAgain}>
              Gerar Outro Deck
            </Button>
          </form>
        </div>
      ...
      <div className="container mx-auto max-w-2xl">
        <header className="mb-10 text-center">
          ...
          <p className="text-lg text-neutral-300">
            Dê uma ideia, escolha o formato e deixe a IA fazer o trabalho pesado.
          </p>
        </header>
          ...
          <Card className="bg-neutral-900 border-neutral-800">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-2 animate-in fade-in">
                  ...
                  {!commander ? (
                    <AutocompleteInput
                      ...
                      placeholder="Digite o nome de um comandante..."
                    />
                  ) : (
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="user_prompt"
                  name="user_prompt"
                  placeholder="Ex: Um deck tribal de goblins, muito rápido e agressivo."
                  rows={3}
            ...
            <CardFooter className="flex-col items-start gap-4 pt-6">
              <p className="text-xs text-neutral-500">
                Para melhores resultados, forneça uma instrução clara. Para Commander, você pode
                escolher um comandante ou deixar a IA escolher com base nas suas instruções.
              </p>
