                ...
                <div key={type} className="mb-6 break-inside-avoid">
                  ...
                  <ul className="space-y-1">
                    {items.map(({ card, count }) => (
                      <li
                        key={card.id}
                        className="flex justify-between items-center text-sm p-1.5 rounded-md"
                      >
            ...
            {decklist.mainboard.map((item) => {
              ...
              return (
                <div key={card.id} className="relative">
                  ...
                  />
                  <div className="absolute top-1 right-1 bg-black/80 text-white font-bold text-xs h-6 w-6 flex items-center justify-center rounded-full border-2 border-white">
                    {item.count}
                  </div>
                </div>
              );
