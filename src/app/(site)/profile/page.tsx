    ...
    try {
      ...
      const updates =
        type === 'avatar'
          ...
          : { [fieldToUpdate]: publicUrl, cover_position_y: 50 };
    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      >
        ...
        <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
          <label
            ...
            className="bg-black/50 p-2 rounded-full cursor-pointer hover:bg-black/70 transition"
            title="Carregar nova capa"
          >
        ...
        {profile?.cover_image_url && (
          <div className="absolute bottom-4 right-4 w-1/3 max-w-xs opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-3">
            ...
            <input
              ...
              onChange={(e) =>
                setProfile((p) => (p ? { ...p, cover_position_y: parseInt(e.target.value) } : null))
              }
        ...
        <div className="absolute -bottom-16 left-1/2 -translate-x-1/2">
          <div className="relative h-32 w-32 rounded-full border-4 border-neutral-950 bg-neutral-700">
            ...
            <label
              ...
              className="absolute bottom-1 right-1 bg-black/50 p-2 rounded-full cursor-pointer hover:bg-black/70 transition"
            >
      ...
      <div className="max-w-4xl mx-auto pt-24 pb-12 px-4 space-y-8">
        ...
        <Card className="bg-neutral-900 border-neutral-800">
          <CardHeader>
            <CardTitle className="text-xl font-semibold text-amber-500">
              Gamificação e Recompensas
            </CardTitle>
            <CardDescription>Seus pontos e seu link para convidar amigos.</CardDescription>
          </CardHeader>
        ...
        <div className="p-8 bg-neutral-900 rounded-lg border border-neutral-800 space-y-6">
          <h2 className="text-xl font-semibold text-amber-500 border-b border-neutral-700 pb-2">
          ...
          <h2 className="text-xl font-semibold text-amber-500 border-b border-neutral-700 pb-2 pt-4">
            Preferências de Magic
          </h2>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              {ALL_FORMATS.map((format) => (
                <Toggle
                  key={format}
                  pressed={profile?.favorite_formats?.includes(format)}
                  onPressedChange={(isPressed) => handleFormatChange(format, isPressed)}
                  variant="outline"
                >
                  {format}
                </Toggle>
          ...
          {message && (
            <Alert
              ...
              className={message.type === 'success' ? 'bg-green-500/10 border-green-500/30' : ''}
            >
