    ...
    >
      <div className="p-4 border-b border-neutral-800 flex items-center justify-center">
        <Link href="/admin">
          <h1
            className={cn(
              'font-bold text-xl text-amber-500 transition-opacity whitespace-nowrap',
      ...
      <div className="p-4 border-t border-neutral-800 space-y-2">
        <Link href="/" title="Voltar ao Site">
          <div
            className={cn(
              'flex items-center gap-3 px-4 py-2 rounded-md text-sm font-medium text-neutral-300 hover:bg-neutral-800 hover:text-amber-400',
              isCollapsed && 'justify-center',
            )}
          >
