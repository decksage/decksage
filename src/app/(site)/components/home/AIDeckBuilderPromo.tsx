  ...
  return (
    <section className="py-24 sm:py-32">
      <div className="container mx-auto px-6">
        <div
          className="relative isolate overflow-hidden bg-neutral-900 px-6 py-24 text-center shadow-2xl rounded-2xl sm:px-16
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-neutral-300">
            Dê um comandante, uma carta que você ama ou apenas uma ideia maluca. Nossa IA vasculha o
            multiverso para construir um deck completo e sinérgico pra você em segundos.
          </p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link href="/ai-deck-builder">
              <Button
                size="lg"
                className="bg-amber-400 text-amber-950 font-bold hover:bg-amber-300 text-base shadow-lg shadow-amber-500/20"
              >
